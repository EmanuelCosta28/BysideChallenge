...
$veiculosSUVHibridos = $veiculos->getHybridSUV();
            ...
            <div class="wrap-table100">
                ...
                <div class="table100">
                    <table>
                        ...
                        <?php
                        foreach ($veiculosSUVHibridos as $veiculo => $caracteristicas) {
                        ?>
                            <tr>
                                <td class="column1">
                    ...
                    <br>
                    <a>Desafio 3 - Listagem de todos os carros do tipo SUV, que estão acima de 18,000.00€ e com o combustível Hibrido.</a>
                </div>
            </div>
        </div>
    </div>
