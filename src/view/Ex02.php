...
$veiculosNaoBrancos = $veiculos->getNotWhiteVehicles();
            ...
            <div class="wrap-table100">
                ...
                <div class="table100">
                    <table>
                        ...
                        <?php
                        foreach ($veiculosNaoBrancos as $veiculo => $caracteristicas) {
                        ?>
                            <tr>
                                <td class="column1">
                    ...
                    <br>
                    <a>Desafio 2 - Listagem de todos os veículos de cor diferente de Branco.</a>
                </div>
            </div>
        </div>
    </div>
